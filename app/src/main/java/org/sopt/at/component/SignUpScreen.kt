...
import org.sopt.at.component.ui.theme.ATSOPTANDROIDTheme
...
fun SignUpScreen(
    ...
    val isVisiblePassword by remember { mutableStateOf(false) }
    ...
    Column(
        ...
        Button(
            ...
            Text(buttonText, color = Color.LightGray)
        }
    }
